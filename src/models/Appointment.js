...
module.exports = (sequelize) => {
  return sequelize.define('Appointment', {
    ...
    ratingSent: { type: DataTypes.BOOLEAN, defaultValue: false, comment: 'Indica si ya se envió solicitud de calificación (WhatsApp)' },
    ratingSentAt: { type: DataTypes.DATE, comment: 'Fecha cuando se envió la solicitud de calificación (WhatsApp)' },
    ratingEmailSent: { type: DataTypes.BOOLEAN, defaultValue: false, comment: 'Indica si ya se envió el email de solicitud de calificación' },
    ratingEmailSentAt: { type: DataTypes.DATE, comment: 'Fecha cuando se envió el email de solicitud de calificación' },
    ratingSubmittedAt: { type: DataTypes.DATE, comment: 'Fecha cuando el cliente envió la calificación' },
    ...
    suppliesCost: { type: DataTypes.DECIMAL(10, 2), defaultValue: 0, comment: 'Costo de insumos usados en esta cita (se resta antes de calcular comisión)' },
